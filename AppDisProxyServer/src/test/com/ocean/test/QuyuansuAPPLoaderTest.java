...
public class QuyuansuAPPLoaderTest {
	...
	public void getAppList(){
		...
		try {
            ...
            adreq.setJoinSource(JoinSource.QUQUANSU_APPSTORE);
           ...
           // token.setValue("30F7EBDE99881AC599A8E76F29E82729");
            token.setValue("422072DEDFCD0DCD41EAA25ADEB94E09");
            extL.add(token);
