...
public class BaitongAPPLoaderTest {
...
/*		    try {
	...
	public void getAppList(){
		...
		try {
            ...
            adreq.setJoinSource(JoinSource.BAIDUBAITONG_APPSTORE);
            ...
            ExtData apk_id=new ExtData();
            apk_id.setKey("apk_id");
            apk_id.setValue("1b8a409c5507c64d68f676bd75f2f295");
            extL.add(apk_id);  
            
            ExtData secret=new ExtData();
            secret.setKey("secret");
            secret.setValue("baidur2o0s1e3qaq123465");
            extL.add(secret);
