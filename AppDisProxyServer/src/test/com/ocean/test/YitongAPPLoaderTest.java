...
public class YitongAPPLoaderTest {
	...
	public void getAppList(){
		...
		try {
			...
			interParam.setKeyWord("视频");
			interParam.setPkgName("com.duowan.kiwi");
			adreq.setInterParam(interParam);
			
            adreq.setAppSpaceInfo(space);
            adreq.setJoinSource(JoinSource.YITONG_APPSTORE);
            ...
            ExtData developerid=new ExtData();
            developerid.setKey("developerid");
            developerid.setValue("5");
            extL.add(developerid);
            
            //list
/*            ExtData appid=new ExtData();
            appid.setKey("appid");
            appid.setValue("100798");*/
            
          //keyword
/*            ExtData appid=new ExtData();
            appid.setKey("appid");
            appid.setValue("100803");
            extL.add(appid);*/
            ...
            //list
/*            ExtData spaceid=new ExtData();
            spaceid.setKey("itemspaceid");
            spaceid.setValue("16103");*/
            
            //keyword
/*            ExtData spaceid=new ExtData();
            spaceid.setKey("itemspaceid");
            spaceid.setValue("16108");
            extL.add(spaceid);*/
            //pkg
            ExtData spaceid=new ExtData();
            spaceid.setKey("itemspaceid");
