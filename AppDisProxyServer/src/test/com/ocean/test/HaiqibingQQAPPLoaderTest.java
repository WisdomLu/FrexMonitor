...
public class HaiqibingQQAPPLoaderTest {
...
/*			
            ...
            ExtData bi=new ExtData();
            bi.setKey(QQDownloaderRequest.BUSINESSID);
            bi.setValue("cx_api_hqb");
            extL.add(bi);
            ExtData bk=new ExtData();
            bk.setKey(QQDownloaderRequest.BUSINESSKEY);
            bk.setValue("21dbbc48a6163fcc5ee7c4c490d9ec23");
            extL.add(bk);
