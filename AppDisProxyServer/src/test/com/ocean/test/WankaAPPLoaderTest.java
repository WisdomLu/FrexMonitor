...
public class WankaAPPLoaderTest {
...
/*		    try {
	...
	public void getAppList(){
		...
		try {
            ...
            adreq.setJoinSource(JoinSource.WANKA_APPSTORE);
            ...
            ExtData app_id=new ExtData();
            app_id.setKey("app_id");
            app_id.setValue("b1062a");
            extL.add(app_id);
            
            ExtData ch=new ExtData();
            ch.setKey("channel_id");
            ch.setValue("20062a");
            extL.add(ch);  
            
            ExtData secret=new ExtData();
            secret.setKey("appSecret");
            secret.setValue("JmZw0xqyDWIHr5EVWT7u6JEUePc4tY3I");
            extL.add(secret);
