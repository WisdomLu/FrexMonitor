...
public enum FuxiQQMethodType {
	...
	private FuxiQQMethodType(int value, String name) {
		this.value = value;
		this.name = name;
	}
	...
	public static FuxiQQMethodType getDsp(int value){
		
		FuxiQQMethodType[] types = values();
		for (FuxiQQMethodType interType : types) 
		{
