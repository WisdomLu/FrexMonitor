...
import com.ocean.task.QuyuansuKwdTask;

/** * @author Alex & E-mail:569246607@qq.com
      @date   2018年5月10日 
      @version 1.0 
 */
@Component(value="QuyuansuKwdSearchHandler")
public class QuyuansuKwdSearchHandler   extends QuyuansuBaseHandler{
	@Override
	public AppDisResponse invok(AppDisRecomReq req) throws AppDisException {
		// TODO Auto-generated method stub
		QuyuansuKwdSchReq request=parseKeywordSearchParam(req);
		return (QuyuansuKwdSchResp)this.invoke(request, QuyuansuKwdSchResp.class, req.getUserInfo().getUid(),String.valueOf(req.getAppSpaceInfo().getAdSpaceId()));
		
	}
	public AppDisResponse invok(AppDisRecomReq proxyReq,QuyuansuKwdSchReq req) throws AppDisException {
		// TODO Auto-generated method stub
		return (QuyuansuKwdSchResp)this.invoke(req, QuyuansuKwdSchResp.class, proxyReq.getUserInfo().getUid(),String.valueOf(proxyReq.getAppSpaceInfo().getAdSpaceId()));
		
	}
	public QuyuansuKwdSchReq parseKeywordSearchParam(AppDisRecomReq req) throws AppDisException{
		...
		QuyuansuKwdSchReq param =new QuyuansuKwdSchReq();
	...
	public AsynAbstractTask packageTask(Parameter params, String hashCode) {
		// TODO Auto-generated method stub
		QuyuansuKwdTask task = new QuyuansuKwdTask();
		QuyuansuKwdSchReq param = (QuyuansuKwdSchReq) params;
		
		StringBuilder url = new StringBuilder();
		url.append(SystemContext.getDynamicPropertyHandler().get(AppDisConstants.QUYUANSU_KWD_URL));
