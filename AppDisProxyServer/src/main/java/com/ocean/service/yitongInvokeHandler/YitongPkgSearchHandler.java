...
import com.ocean.task.YitongPkgTask;
...
/** * @author Alex & E-mail:569246607@qq.com
      ...
      @version 1.0 
 */
@Component(value="YitongPkgSearchHandler")
public class YitongPkgSearchHandler   extends BaseHandler{
	...
	public AppDisResponse invok(AppDisRecomReq req) throws AppDisException {
		...
		YitongPkgSchReq request=parsepPkgSearchParam(req);
		return invok(req,request);
	}
	public AppDisResponse invok(AppDisRecomReq proxyReq,YitongPkgSchReq request) throws AppDisException {
		// TODO Auto-generated method stub
		return (YitongPkgSchResp)this.invoke(request, YitongPkgSchResp.class, proxyReq.getUserInfo().getUid(),String.valueOf(proxyReq.getAppSpaceInfo().getAdSpaceId()));
		
	}
	public YitongPkgSchReq parsepPkgSearchParam(AppDisRecomReq req) throws AppDisException{
		...
		YitongPkgSchReq param =new YitongPkgSchReq();
		...
		if(StringUtil.isEmpty(interParam.getPkgName())){
			throw new AppDisException(AppDisErrorCode.RC_PARAM_ERROR,"pkgname parameter is empty!");
		}
		String pgkNames=interParam.getPkgName();
		param.setPackagenames(pgkNames);
		param.setAd_type(1);
	...
	public AsynAbstractTask packageTask(Parameter params, String hashCode) {
		// TODO Auto-generated method stub
		YitongPkgTask task = new YitongPkgTask();
		YitongPkgSchReq param = (YitongPkgSchReq) params;
		
	
		StringBuilder url = new StringBuilder();
		url.append(SystemContext.getDynamicPropertyHandler().get(AppDisConstants.YITONG_PKG_URL));
