...
import com.ocean.persist.app.dis.appSearch360T2.BaseSearch360T2Response;
...
import com.ocean.service.qihooT2InvokeHandler.base.Qihoo360T2InvokeHandlerFactory;
...
/** * @author Alex & E-mail:569246607@qq.com
      ...
      @version 1.0 
 */
@Component(value="Qihoo360T2AppStoreAppSupplier")
public class Qihoo360T2AppStoreAppSupplier  extends QihooAppStoreSupplierBase{
	...
	private AppDisRecomReply parseResp(AppDisRecomReq req,BaseSearch360T2Response resp) throws AppDisException{
...
/*	            if(CollectionUtils.isNotEmpty(track.getTk_clk())){
	...
	private AppDisRecomReply keyWordSearch(AppDisRecomReq req) throws AppDisException{
		Qihoo360T2KeywordSearchHandler handler=(Qihoo360T2KeywordSearchHandler)Qihoo360T2InvokeHandlerFactory.getHandler(QihooMethodType.KEYWORD_SEARCH);
		return parseResp(req,(KeywordSearch360T2Response)handler.invok(req));

	}
	private AppDisRecomReply appRecommendSearch(AppDisRecomReq req) throws AppDisException{
		Qihoo360T2AppRcmdSearchHandler handler=(Qihoo360T2AppRcmdSearchHandler)Qihoo360T2InvokeHandlerFactory.getHandler(QihooMethodType.APP_RECOMMEND_SEARCH);
		return parseResp(req,(AppRcmd360T2Response)handler.invok(req));

	}
	private AppDisRecomReply pkgSearch(AppDisRecomReq req) throws AppDisException{
		
		Qihoo360T2PkgSearchHandler handler=(Qihoo360T2PkgSearchHandler)Qihoo360T2InvokeHandlerFactory.getHandler(QihooMethodType.PACKAGE_SEARCH);
		return parseResp(req,(PkgSearch360T2Resp)handler.invok(req));
	}
