package com.ocean.service.quyuansu2InvokHandler;
...
import com.ocean.task.QuyuansuRandomTask;


@Component(value="Quyuansu2RcmdSearchHandler")
public class Quyuansu2RcmdSearchHandler   extends QuyuansuBaseHandler{
	@Override
...
//		QuyuansuListSchReq request=parseListSearchParam(req);
		RandomSearchQuyuansuReq request=parseRandomSearchParam(req);
		...
		return (RandomSearchQuyuansuResp)this.invoke(request, RandomSearchQuyuansuResp.class, req.getUserInfo().getUid(),String.valueOf(req.getAppSpaceInfo().getAdSpaceId()));
	}
	public AppDisResponse invok(AppDisRecomReq proxyReq,RandomSearchQuyuansuReq req) throws AppDisException {
		// TODO Auto-generated method stub
		return (RandomSearchQuyuansuResp)this.invoke(req, RandomSearchQuyuansuResp.class, proxyReq.getUserInfo().getUid(),String.valueOf(proxyReq.getAppSpaceInfo().getAdSpaceId()));
		
	}
	public RandomSearchQuyuansuReq parseRandomSearchParam(AppDisRecomReq req) throws AppDisException{
		...
		RandomSearchQuyuansuReq param =new RandomSearchQuyuansuReq();
...
//		}
	...
	public AsynAbstractTask packageTask(Parameter params, String hashCode) {
		// TODO Auto-generated method stub
		QuyuansuRandomTask task = new QuyuansuRandomTask();
		RandomSearchQuyuansuReq param = (RandomSearchQuyuansuReq) params;
		
		StringBuilder url = new StringBuilder();
		url.append(SystemContext.getDynamicPropertyHandler().get(AppDisConstants.QUYUANSU2_RCMD_URL));
