...
/** * @author Alex & E-mail:569246607@qq.com
      ...
      @version 1.0 
 */
public class Quyuansu2InvokeHandlerFactory {
    public static BaseHandler getHandler(Quyuansu2MethodType interType) throws AppDisException{
    	switch(interType){
    	    case PACKAGE_SEARCH:
    	    ...
    	    case RANDOM_SEARCH:
    	    	return  (com.ocean.service.quyuansu2InvokHandler.Quyuansu2RcmdSearchHandler)SystemContext.getServiceHandler().getService(com.ocean.service.quyuansu2InvokHandler.Quyuansu2RcmdSearchHandler.class);
    	    default:
