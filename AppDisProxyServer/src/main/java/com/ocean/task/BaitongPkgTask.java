...
public class BaitongPkgTask  extends AsynAbstractTask<BaitongPkgSearchReq,BaitongPkgSearchResp>{
	...
	@Override
	public BaitongPkgSearchResp respFormat(String result)
			throws Exception {
		// TODO Auto-generated method stub
		BaitongPkgSearchResp resp=null;
		try{
			
			if(StringUtils.isNotEmpty(result)){
				
				resp=JsonUtils.toBean(result, BaitongPkgSearchResp.class);
			}
		}catch (Throwable e) {
	...
	@Override
	public BaitongPkgSearchResp respFormat(byte[] result) {
		// TODO Auto-generated method stub
		return null;
	}
