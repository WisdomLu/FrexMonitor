...
public class QuyuansuKwdTask  extends AsynAbstractTask<QuyuansuKwdSchReq,QuyuansuKwdSchResp>{
	...
	@Override
	public QuyuansuKwdSchResp respFormat(String result)
			throws Exception {
		// TODO Auto-generated method stub
		QuyuansuKwdSchResp resp=null;
		try{
			
			if(StringUtils.isNotEmpty(result)){
				
				resp=JsonUtils.toBean(result, QuyuansuKwdSchResp.class);
			}
		}catch (Throwable e) {
	...
	@Override
	public QuyuansuKwdSchResp respFormat(byte[] result) {
		// TODO Auto-generated method stub
		return null;
	}
