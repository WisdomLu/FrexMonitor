...
public class WanyujxPkgTask  extends AsynAbstractTask<WanyujxPkgSchReq,WanyujxPkgSchResp>{
	...
	@Override
	public WanyujxPkgSchResp respFormat(String result)
			throws Exception {
		// TODO Auto-generated method stub
		WanyujxPkgSchResp resp=null;
		try{
			
			if(StringUtils.isNotEmpty(result)){
				
				resp=JsonUtils.toBean(result, WanyujxPkgSchResp.class);
			}
		}catch (Throwable e) {
	...
	@Override
	public WanyujxPkgSchResp respFormat(byte[] result) {
		// TODO Auto-generated method stub
		return null;
	}
