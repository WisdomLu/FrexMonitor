 		...
 		new Thread()
        {
            public void run()
            {
            	...
            	try {
            		...
            		int queueBufferSize = SystemContext.getDynamicPropertyHandler().getInt(ProxyConstants.THRIFT_ACCEPT_QUEUE_SIZE, 16);
            		...
            		TProcessor tProcessor=new AppDisRecommend.Processor<ProxyInvoker>(new ProxyInvoker());
