...
/** * @author Alex & E-mail:569246607@qq.com
      ...
      @version 1.0 
 */
public class QidianAdPullResponse  extends AbstractBaseEntity  implements AdPullResponse{
	...
	private QidianData data;// 返回数据，详细字段如下行起描述
	public int getCode() {
		return code;
	}
	...
	public QidianData getData() {
		return data;
	}
	public void setData(QidianData data) {
		this.data = data;
	}
}
