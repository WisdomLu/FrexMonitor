...
/** * @author Alex & E-mail:569246607@qq.com
      ...
      @version 1.0 
 */
public abstract class AbstractQQDownloaderPuller  implements BaseAppPuller{
	  private static final String PARAM_BODY="body"; 
	  private static final String PARAM_HEAD="head"; 
	  public String getUrl(QQDownloaderRequest attri) throws AppDisException{
		   String url=SystemContext.getDynamicPropertyHandler().get(AppDisConstants.QQDOWNLOADER_URL);
		   if(StringUtils.isEmpty(url)){
			   throw new AppDisException(AppDisErrorCode.RC_PARAM_ERROR, "param error,qqdownloader getcategorylist_url is empty");
		   }
