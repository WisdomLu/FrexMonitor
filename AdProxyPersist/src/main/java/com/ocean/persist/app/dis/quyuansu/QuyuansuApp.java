...
public class QuyuansuApp {
		...
		private String signatrue;//：该 APK 包的签名 
		private String md5;//：APK 的 MD5 校验值 
		private String pubKeySignature;//：RSA 签名中公钥的 md5 值 
		private String minSdkVersion;//：支持的最小版本的 android api level 
		private String adsType;//：有无广告 
		private String paidType;//：有无付费 
		private String permissions;//：该 APK 需要的权限 
		private String securityStatus;//：有无病毒 
		private String official;//：是否是官方应用 
		private String language;//：语言 
		private String publishDate;//：发布日志 
		private String creation;//：创建时间，即最新的 APK 的发布时间 
		private String sequence;//：序列号
		private String appId;//：应用  ID 
		private String apkId;//：应用安装包  ID 
		private int is_ad;
