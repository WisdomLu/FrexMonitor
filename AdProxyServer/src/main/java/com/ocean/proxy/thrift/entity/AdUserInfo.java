...
@Generated(value = "Autogenerated by Thrift Compiler (0.9.2)", date = "2019-2-22")
public class AdUserInfo implements org.apache.thrift.TBase<AdUserInfo, AdUserInfo._Fields>, java.io.Serializable, Cloneable, Comparable<AdUserInfo> {
  ...
  private static final org.apache.thrift.protocol.TField TAG_FIELD_DESC = new org.apache.thrift.protocol.TField("tag", org.apache.thrift.protocol.TType.LIST, (short)27);
  ...
  private static final org.apache.thrift.protocol.TField UA_WEBV_FIELD_DESC = new org.apache.thrift.protocol.TField("ua_webv", org.apache.thrift.protocol.TType.STRING, (short)29);
  ...
  public List<String> tag; // optional
  public int dev_price_level; // optional
  public String ua_webv; // optional
  ...
  static {
    ...
    tmpMap.put(_Fields.DEV_PRICE_LEVEL, new org.apache.thrift.meta_data.FieldMetaData("dev_price_level", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
    tmpMap.put(_Fields.UA_WEBV, new org.apache.thrift.meta_data.FieldMetaData("ua_webv", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
  ...
  public AdUserInfo(AdUserInfo other) {
    ...
    if (other.isSetTag()) {
      List<String> __this__tag = new ArrayList<String>(other.tag);
      this.tag = __this__tag;
    }
    this.dev_price_level = other.dev_price_level;
    if (other.isSetUa_webv()) {
      this.ua_webv = other.ua_webv;
    }
  }
  ...
  public AdUserInfo setDip(String dip) {
    this.dip = dip;
    return this;
  }
  ...
  public AdUserInfo setDensity(String density) {
  ...
  public AdUserInfo setCity_name(String city_name) {
  ...
  public AdUserInfo setLac(int lac) {
    this.lac = lac;
    setLacIsSet(true);
    return this;
  }
  ...
  public AdUserInfo setCid(int cid) {
    this.cid = cid;
    setCidIsSet(true);
    return this;
  }
  ...
  public AdUserInfo setOs_api_level(String os_api_level) {
  ...
  public AdUserInfo setSn(String sn) {
    this.sn = sn;
    return this;
  }
  ...
  public java.util.Iterator<String> getTagIterator() {
    return (this.tag == null) ? null : this.tag.iterator();
  }

  public void addToTag(String elem) {
    if (this.tag == null) {
  ...
  public AdUserInfo setTag(List<String> tag) {
    this.tag = tag;
    return this;
  }
  ...
  public AdUserInfo setDev_price_level(int dev_price_level) {
  ...
  public String getUa_webv() {
    return this.ua_webv;
  }

  public AdUserInfo setUa_webv(String ua_webv) {
    this.ua_webv = ua_webv;
    return this;
  }

  public void unsetUa_webv() {
    this.ua_webv = null;
  }

  /** Returns true if field ua_webv is set (has been assigned a value) and false otherwise */
  public boolean isSetUa_webv() {
    return this.ua_webv != null;
  }

  public void setUa_webvIsSet(boolean value) {
    if (!value) {
      this.ua_webv = null;
    }
  }
  ...
  public boolean equals(AdUserInfo that) {
    ...
    boolean this_present_ua_webv = true && this.isSetUa_webv();
    boolean that_present_ua_webv = true && that.isSetUa_webv();
    if (this_present_ua_webv || that_present_ua_webv) {
      if (!(this_present_ua_webv && that_present_ua_webv))
        return false;
      if (!this.ua_webv.equals(that.ua_webv))
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_ua_webv = true && (isSetUa_webv());
    list.add(present_ua_webv);
    if (present_ua_webv)
      list.add(ua_webv);
  ...
  public int compareTo(AdUserInfo other) {
    ...
    lastComparison = Boolean.valueOf(isSetUa_webv()).compareTo(other.isSetUa_webv());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetUa_webv()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.ua_webv, other.ua_webv);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    if (isSetUa_webv()) {
      if (!first) sb.append(", ");
      sb.append("ua_webv:");
      if (this.ua_webv == null) {
        sb.append("null");
      } else {
        sb.append(this.ua_webv);
      }
      first = false;
    }
    sb.append(")");
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, AdUserInfo struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.tag = new ArrayList<String>(_list0.size);
                String _elem1;
                for (int _i2 = 0; _i2 < _list0.size; ++_i2)
                {
                  _elem1 = iprot.readString();
                  struct.tag.add(_elem1);
                }
                iprot.readListEnd();
              }
          ...
          case 29: // UA_WEBV
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.ua_webv = iprot.readString();
              struct.setUa_webvIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, AdUserInfo struct) throws org.apache.thrift.TException {
      ...
      if (struct.tag != null) {
        if (struct.isSetTag()) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRING, struct.tag.size()));
            for (String _iter3 : struct.tag)
            {
      ...
      if (struct.ua_webv != null) {
        if (struct.isSetUa_webv()) {
          oprot.writeFieldBegin(UA_WEBV_FIELD_DESC);
          oprot.writeString(struct.ua_webv);
          oprot.writeFieldEnd();
        }
      }
      ...
      if (incoming.get(26)) {
        {
          ...
          struct.tag = new ArrayList<String>(_list5.size);
          String _elem6;
          for (int _i7 = 0; _i7 < _list5.size; ++_i7)
          {
            _elem6 = iprot.readString();
            struct.tag.add(_elem6);
          }
        }
        struct.setTagIsSet(true);
      }
