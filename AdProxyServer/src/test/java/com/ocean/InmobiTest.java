...
public class InmobiTest {
	...
	//private static final int zkpos =472;//banner
	//private static final int zkpos =473;//信息流
	private static final int zkpos =474;//开屏
	/**
	 * @param args
	...
	public static void main(String[] args) throws InterruptedException, UnsupportedEncodingException {
		...
		int i = 1;
		while(i > 0){
			InmobiTest client = new InmobiTest();
	...
	public AdRecomReply startClient_infoflow(){
		...
		try {
			...
			userInfo.setImei("99000560778072");
...
//			userInfo.setPhonemodel("iPhone 7");
			...
			userInfo.setAdid("de82b7e535439a29");
...
//			userInfo.setUa("AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 OPR/12.0.0.2147483647 Mobile Safari/537.36");
			...
			attri.setSpaceHeight(627);
			attri.setSpaceWidth(1200);
			...
			attri.setCwMin(0);
			attri.setCwMax(100);
			attri.setJoinDspName(JoinDSPEmu.INMOBI.getAbbrev());
...
/*			userInfo.setLat("22.606714");
	...
	public AdRecomReply startClient_openning(){
		...
		try {
			...
			userInfo.setOs("android");
			userInfo.setImei("866867021441253");
			userInfo.setImsi("460003192536418");
			// 116.226.72.4 58.221.56.201
			userInfo.setClient_ip("116.236.204.78");
			userInfo.setOsversion("5.0");
//			userInfo.setPhonemodel("iPhone 7");
