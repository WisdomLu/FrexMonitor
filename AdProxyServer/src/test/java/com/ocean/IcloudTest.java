...
public class IcloudTest {
	...
	private static final int zkpos =471;
	...
	public static void main(String[] args) throws InterruptedException, UnsupportedEncodingException {
		...
		int i = 1;
		while(i > 0){
			IcloudTest client = new IcloudTest();
...
//			userInfo.setUa("AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 OPR/12.0.0.2147483647 Mobile Safari/537.36");
			...
			attri.setSpaceHeight(500);
			attri.setSpaceWidth(600);
			...
			attri.setCwMin(0);
			attri.setCwMax(100);
			attri.setJoinDspName(JoinDSPEmu.ICLOUD.getAbbrev());
