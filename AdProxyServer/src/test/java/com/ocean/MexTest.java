...
/*
 * 广告位ID  应用商城-android-开屏 59c8b27a9cf5920100884dfe   应用商城-android-banner   59c8b2bddfe7cf0100734cdd   应用商城-android-信息流 59c8b2f9dfe7cf0100734cec
...
public class MexTest {
	...
	private static final int zkpos =479;//
...
//			userInfo.setUa("AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 OPR/12.0.0.2147483647 Mobile Safari/537.36");
			...
			attri.setCwMin(0);
			attri.setCwMax(100);
			attri.setJoinDspName(JoinDSPEmu.MEX.getAbbrev());
...
//			userInfo.setUa("AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 OPR/12.0.0.2147483647 Mobile Safari/537.36");
			...
			attri.setSpaceHeight(1280);

			attri.setSpaceWidth(768);
			attri.setAllowedOpentype(1);
			attri.setSpacePosition(0);
			Set<AdSpaceImgFmt> imgFormats=new HashSet<AdSpaceImgFmt> ();
			imgFormats.add(AdSpaceImgFmt.GIF);imgFormats.add(AdSpaceImgFmt.JPG);
